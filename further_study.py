...
def custom_reverse(input_list):
    ...
    middle = (custom_len(input_list)//2)

    for index in range(0 , middle):
        first = input_list[index]
        input_list[index] = input_list[len(input_list) - 1 - index]
        input_list[len(input_list) - 1 - index] = first 
